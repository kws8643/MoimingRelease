...
public interface GroupPaymentRetrofitService {
    ...
    Observable<TransferModel<GroupPaymentResponseDTO>> paymentCreate(@Body TransferModel<GroupPaymentRequestDTO> requestModel);
    ...
    Observable<TransferModel<GroupPaymentResponseDTO>> updatePayment(@Body TransferModel<GroupPaymentRequestDTO> requestModel, @Path("uuid") String paymentUuid);
